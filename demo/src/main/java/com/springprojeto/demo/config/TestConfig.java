...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order o1 = new Order(null, Instant.parse("2024-05-03T19:53:07Z"), u1);
        Order o2 = new Order(null, Instant.parse("2024-05-04T20:53:07Z"), u2);
        Order o3 = new Order(null, Instant.parse("2024-05-05T09:53:07Z"), u1);
